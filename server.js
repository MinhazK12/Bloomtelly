...
const horrorenglish = require('./routes/horrorenglish')
...
app.use('/nrhindi', akbarenglish)
app.use('/nrhindi', akbarhindi)
app.use('/nrhindi', alien)
app.use('/nrhindi', backbenchers)
app.use('/nrhindi', horrorenglish)
app.use('/nrhindi', nrenglish)
app.use('/nrhindi', panchatantra)
app.use('/nrhindi', premium)
app.use('/nrhindi', rohanrobothindi)
app.use('/nrhindi', tenalienglish)
